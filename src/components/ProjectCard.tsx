...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-blue-600 hover:-translate-y-1 h-full flex flex-col overflow-hidden">
      {/* Project image */}
