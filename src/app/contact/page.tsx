      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="mb-4">Speak to us directly</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-12">
            ...
            <div className="card p-8 text-center">
              ...
              <a
                ...
                className="text-2xl font-semibold text-primary-600 hover:text-primary-700 block mb-2"
              >
                {company.contact.phoneDisplay}
              </a>
              <p className="text-sm text-neutral-600">Available during business hours</p>
            </div>
            ...
            <div className="card p-8 text-center">
              ...
              <a
                ...
                className="btn btn-secondary inline-block mb-2"
              >
                Message us on WhatsApp
              </a>
              <p className="text-sm text-neutral-600">Quick responses, send photos of your space</p>
            </div>
        ...
        <div className="container-custom">
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-8">
              <h2 className="mb-4">Contact & Quote Request Form</h2>
              <p className="text-neutral-600">Fill in the form below and we&apos;ll get back to you as soon as possible</p>
            </div>
