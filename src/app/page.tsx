...
export default function Home() {
  return (
    <main id="main-content">
      {/* Modern Hero Section */}
      <section className="relative min-h-screen pt-20 pb-24 flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
        {/* Hero Content */}
