  ...
  return (
    <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-gray-200 shadow-2xl">
      <div className="grid grid-cols-3 gap-px bg-gray-200">
        ...
        {/* WhatsApp Button */}
        <a
          href={`https://wa.me/${company.contact.whatsapp.replace(/\s/g, '').replace('+', '')}`}
          target="_blank"
          rel="noopener noreferrer"
          className="flex flex-col items-center justify-center bg-gradient-to-br from-green-600 to-green-700 text-white py-3 px-2 hover:from-green-700 hover:to-green-800 transition-all duration-200 active:scale-95"
